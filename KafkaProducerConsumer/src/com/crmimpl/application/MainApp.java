package com.crmimpl.application;
...
import com.crmimpl.consumer.ConsumerCreator;
import com.crmimpl.intf.IKafkaConstants;
import com.crmimpl.producer.ProducerCreator;
...
public class MainApp {
	...
	static void runProducer() {
		...
		for (int index = 0; index < IKafkaConstants.MESSAGE_COUNT; index++) {
			...
			//ProducerRecord<Long, String> record = new ProducerRecord<Long, String>(IKafkaConstants.TOPIC_NAME,new Long(index),
			//		"This is record " + index);
			try {
